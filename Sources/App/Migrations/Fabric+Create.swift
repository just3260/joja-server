    ...
    struct Create: AsyncMigration {
        func prepare(on database: Database) async throws {
            ...
            try await database
                ...
                .field(Fabric.Keys.material, materialType, .required)
                .field(Fabric.Keys.cottonType, cottonType)
                .field(Fabric.Keys.age, ageType, .required)
                .field(Fabric.Keys.design, designType, .required)
                .field(Fabric.Keys.color, colorType, .required)
