...
extension User {
    struct Seed: AsyncMigration {
        func prepare(on database: Database) async throws {
            ...
            let users: [User] = [
                .init(username: "andrewang", email: "just3260@gmail.com", passwordHash: try Bcrypt.hash("a12345678"), isAdmin: true, permissions: 2047),
                .init(username: "andrew", email: "andrew@ins.to", passwordHash: try Bcrypt.hash("a12345678"), permissions: 2047),
                .init(username: "josie", email: "joja.design@hatmail.com", passwordHash: try Bcrypt.hash("Aa0909"), permissions: 2047),
                .init(username: "jn", email: "jnhuang870910@gmail.com", passwordHash: try Bcrypt.hash("0935870936"), permissions: 127),
                ...
                .init(username: "kechan", email: "j11223344tw@gmail.com", passwordHash: try Bcrypt.hash("88888888")),
                .init(username: "remi", email: "remi.2002r@gmail.com", passwordHash: try Bcrypt.hash("88888888")),
                .init(username: "judy", email: "judy9719666@icloud.com", passwordHash: try Bcrypt.hash("88888888"))
            ]
